...
class CShadowWnd : public CWindowWnd, public INotifyUI
{
private:
    bool m_bNeedUpdate;
	TDrawInfo m_di;
...
public:
    ...
    void RePaint() 
    {
        ...
        CRenderEngine::DrawImage(hDcBackground, &m_pm, rcClient, rcClient, m_di, false);
...
class CShadowMenuWnd : public CWindowWnd, public INotifyUI
{
public:
    CShadowMenuWnd() : m_pOwner(NULL), m_pShadowWnd(NULL) { };
